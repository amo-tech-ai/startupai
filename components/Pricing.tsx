      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
             ...
             <div className="border border-slate-200 rounded-2xl p-8 hover:shadow-xl transition-all">
                ...
                <button className="w-full py-3 rounded-lg border border-slate-200 font-semibold text-slate-700 mb-8 hover:bg-slate-50">Get Started</button>
             ...
             <div className="border-2 border-primary-600 rounded-2xl p-8 shadow-xl relative transform scale-105 bg-white">
                ...
                <button className="w-full py-3 rounded-lg bg-primary-600 text-white font-semibold mb-8 hover:bg-primary-700 shadow-lg shadow-primary-600/20">Start Free Trial</button>
                <ul className="space-y-4 text-left text-sm text-slate-600">
             ...
             <div className="border border-slate-200 rounded-2xl p-8 hover:shadow-xl transition-all">
                ...
                <button className="w-full py-3 rounded-lg border border-slate-200 font-semibold text-slate-700 mb-8 hover:bg-slate-50">Contact Sales</button>
                 <ul className="space-y-4 text-left text-sm text-slate-600">
