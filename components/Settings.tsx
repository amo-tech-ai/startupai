...
import { Save, User, Building2, Briefcase, DollarSign, Globe, Check } from 'lucide-react';
      ...
      <div className="container mx-auto max-w-3xl">
        <div className="flex items-center justify-between mb-8">
            <div>
                ...
                <p className="text-slate-500">Manage your startup profile and preferences.</p>
            </div>
            <button 
                onClick={handleSave}
                disabled={isLoading}
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div className="flex border-b border-slate-200 bg-slate-50">
                <button className="px-6 py-4 text-sm font-bold text-indigo-600 border-b-2 border-indigo-600 bg-white">General Profile</button>
                <button className="px-6 py-4 text-sm font-bold text-slate-500 hover:text-slate-700">Team</button>
                <button className="px-6 py-4 text-sm font-bold text-slate-500 hover:text-slate-700">Billing</button>
            </div>
